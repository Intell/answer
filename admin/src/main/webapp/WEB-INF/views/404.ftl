...
<head>
    <title>
      404错误页面_大气漂亮的Bootstrap后台管理系统模板Se7en - JS代码网
    </title>
	...
	<script src="${base}/javascripts/application.js" type="text/javascript"></script>
  ...
  <body class="fourofour">
    ...
    <div class="fourofour-container">
      ...
      <a class="btn btn-lg btn-default-outline" href="index-2.html"><i class="icon-home"></i>Go to the homepage</a>
    </div>
    <!-- End Login Screen -->
  </body>
